...
*------------------------------------------------------------;                                                                          
* Select participants and identify maternal uncle/aunt(s)    ;                                                                          
*------------------------------------------------------------;                                                                                                                                                                                                                                                                                                         
proc sql;                                                                                                                               
  create table s1 as                                                                                                                    
...
*-- Join in mother and father id (also maternal grandparents for family id);                                                                                                       
proc sql;                                                                                                                               
  create table s2 as                                                                                                                    
  select a.*, b.mother as mother, b.father as father, b.ma_gma as MGM, b.ma_gpa as MGP                                                                                
  from s1 as a                                                                                                                          
...
data s5;                                                                                                                                
  ...
  attrib masib_typ length=$16 label='Sibling type' masib length=8 label='Maternal sibling ID';
