...
%let slask1='P:\0RECAP\0RECAP_Research\sasproj\REC\REC1901\sasout';
...
cards;
14  ASD  Maternal Uncles            Crude              6273.5  26.8      130720       96       3.22 2.54 3.91
13  ASD  Maternal Uncles            Adjusted 1         805.1   54.5      385521      869       2.75 2.15 3.36
12  ASD  Maternal Uncles            Adjusted 2         805.1   54.5      385521      869       1.92 1.54 2.43
11  ASD  Maternal Uncles            Adjusted 3         805.1   54.5      385521      869       2.07 1.67 2.68
9   ASD  Maternal Aunts             Crude              154.6   48.6   148053914   313739       2.73 1.88 3.73
8   ASD  Maternal Aunts             Adjusted 1         463.1   26.3     8750181    14467       2.36 1.62 3.21
7   ASD  Maternal Aunts             Adjusted 2         463.1   26.3     8750181    14467       1.73 1.19 2.35
6   ASD  Maternal Aunts             Adjusted 3         463.1   26.3     8750181    14467       1.58 1.04 2.21
4   ASD  Maternal Aunts or Uncles   Crude              6273.5  26.8      130720       96       3.05 2.52 3.64
3   ASD  Maternal Aunts or Uncles   Adjusted 1         805.1   54.5      385521      869       2.62 2.17 3.14
2   ASD  Maternal Aunts or Uncles   Adjusted 2         463.1   26.3     8750181    14467       1.88 1.54 2.26
1   ASD  Maternal Aunts or Uncles   Adjusted 3         463.1   26.3     8750181    14467       1.89 1.54 2.32
;
run;
...
data asd2;
drop n ref_n cases refcases;
input sorder outcome $ 5-8 lbl $ 10-34 sub $ 36-55 cases refcases n ref_n estimate lower upper ;
can_txt='A'; ** can_txt is a dummy. Doesnt do ANYTHING but need to be there;
...
cards;
14  ASD  Maternal Uncles           Male: Crude            6273.5  26.8      130720       96       2.87 2.16 3.61
13  ASD  Maternal Uncles           Female: Crude          805.1   54.5      385521      869       4.22 2.71 5.98
12  ASD  Maternal Uncles           Male: Adjusted 2       805.1   54.5      385521      869       1.76 1.30 2.25
11  ASD  Maternal Uncles           Female: Adjusted 2     805.1   54.5      385521      869       2.29 1.47 3.39
9   ASD  Maternal Aunts            Male: Crude            154.6   48.6   148053914   313739       2.29 1.38 3.33
8   ASD  Maternal Aunts            Female: Crude          463.1   26.3     8750181    14467       4.41 2.38 7.05
7   ASD  Maternal Aunts            Male: Adjusted 2       463.1   26.3     8750181    14467       1.46 0.88 2.14
6   ASD  Maternal Aunts            Female: Adjusted 2     463.1   26.3     8750181    14467       2.66 1.43 4.31
4   ASD  Maternal Aunts or Uncles  Male: Crude            6273.5  26.8      130720       96       2.68 2.13 3.31
3   ASD  Maternal Aunts or Uncles  Female: Crude          805.1   54.5      385521      869       4.29 3.00 5.76
2   ASD  Maternal Aunts or Uncles  Male: Adjusted 2       463.1   26.3     8750181    14467       1.69 1.34 2.11
1   ASD  Maternal Aunts or Uncles  Female: Adjusted 2     463.1   26.3     8750181    14467       2.45 1.71 3.32
;
run;
...
cards;
12  ASD  Maternal Uncles            Crude              6273.5  26.8      130720       96       3.22 2.54 3.91
11  ASD  Maternal Uncles            Adjusted 1         805.1   54.5      385521      869       2.75 2.15 3.36
10   ASD  Maternal Uncles            Adjusted 2         805.1   54.5      385521      869       1.92 1.54 2.43
8   ASD  Maternal Aunts             Crude              154.6   48.6   148053914   313739       2.73 1.88 3.73
7   ASD  Maternal Aunts             Adjusted 1         463.1   26.3     8750181    14467       2.36 1.62 3.21
6   ASD  Maternal Aunts             Adjusted 2         463.1   26.3     8750181    14467       1.73 1.19 2.35
4   ASD  Maternal Aunts or Uncles   Crude              6273.5  26.8      130720       96       3.05 2.52 3.64
3   ASD  Maternal Aunts or Uncles   Adjusted 1         805.1   54.5      385521      869       2.62 2.17 3.14
2   ASD  Maternal Aunts or Uncles   Adjusted 2         463.1   26.3     8750181    14467       1.88 1.54 2.26
;
...
filename  epsgraf "&slask1/Fig2_v1.png";
...
*-- Adjust ASD2 dataset to a proper SAS annotate dataset;
data annot3a;
  length function $12;
  retain xsys ysys '2' hsys '2' size 0.8;
  set asd2(keep=sorder lower jamatxt rename=(sorder=y lower=x jamatxt=text));
/*
  function='move';  x=x*0.90; y=y-0.1; output;
  function='label'; position='8'; output;
*/
...
filename  epsgraf "P:/0RECAP/0RECAP_Research/sasproj/REC/REC1901/sasout/Fig2_v2.png";
*options reset=all device=eps14x16 /*device=psepsf*/   display gsfname=epsgraf gsfmode=replace rotate=p
         ftext="Times-Roman"
         lfactor=4 htext=2.1 fontres=presentation noborder;
goptions reset=all device=png300 display gsfname=epsgraf gsfmode=replace rotate=p
...
%ssciplt(data=asd2, order=sorder, gout=gseg, annotate=annot4a,
type=2, boxwidth=0.20, hsymbol=1.20, boxcolor=LIGR,
label=lbl, labelposition=LEFTMOST, hlabel=2.6, alabel=90, flabel=Thorndale/Bold AMT,
sublabel=sub, hsublabel=2.2, digits=5.2, fsublabel=Helvetica,
citext=RIGHTMOST, hcitext=2.2, xformat=myx.,
...
*-- Adjust ASD3 dataset to a proper SAS annotate dataset;
data annot3b;
  length function $12;
  retain xsys ysys '2' hsys '2' size 0.8;
  set asd2(keep=sorder lower jamatxt rename=(sorder=y lower=x jamatxt=text));
...
filename  epsgraf "P:/0RECAP/0RECAP_Research/sasproj/REC/REC1901/sasout/Fig2_v3.png";
*options reset=all device=eps14x16 /*device=psepsf*/   display gsfname=epsgraf gsfmode=replace rotate=p
         ftext="Times-Roman"
         lfactor=4 htext=2.1 fontres=presentation noborder;
goptions reset=all device=png300 display gsfname=epsgraf gsfmode=replace rotate=p
...
%ssciplt(data=asd3, order=sorder, gout=gseg, annotate=annot4b,
type=2, boxwidth=0.20, hsymbol=1.20, boxcolor=LIGR,
label=lbl, labelposition=LEFTMOST, hlabel=2.6, alabel=90, flabel=Thorndale/Bold AMT,
sublabel=sub, hsublabel=2.2, digits=5.2, fsublabel=Helvetica,
citext=RIGHTMOST, hcitext=2.2, xformat=myx.,
