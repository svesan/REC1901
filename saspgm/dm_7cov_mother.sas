...
*- 2019-03-10: 'Any mental illness other than ASD' among mothers;
proc sort data=hnew; by lopnr; run;
data ana3;
 drop icd diag any_psych2 any_psych diag_dat;
 length mom_PSYCH2 3;
 merge ana3 (in=ana3) hnew (in=hnew rename=(lopnr=mother));
 by mother;
 if hnew and diag_dat lt child_birth_dat then mom_PSYCH2=1; **Select those diagnosed before child's birth date**;
 else mom_PSYCH2=0;
 if ana3;
run; 
